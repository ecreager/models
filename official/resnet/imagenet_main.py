...
MODEL = '/scratch/gobi1/mweis/models/'
...
_NUM_IMAGES = {
    'train': 1690920, # 1830 images per file
    'validation': 183001, # 1830 images per file except last file has one more
}
...
def _parse_example_proto(example_serialized):
    ...
    feature_map = {
      ...
      'image/class/text': tf.VarLenFeature(dtype=tf.string),
    }
...
def parse_record(raw_record, is_training, dtype):
    ...
    label = tf.reduce_sum(tf.one_hot(label.values, _NUM_CLASSES), 0)
